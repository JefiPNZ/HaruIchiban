 ...
 *
 */
public class BoardTileComFlorComPaiEFilhoteAmarelo implements IBuilder<ModelBoardTile> {
    ...
    public void constroiPartes() {
        try {
            ...
            f.setFilhote(GameController.getInstance().getFactoryPecas().createFilhote(new Color(255, 210, 65)));
            f.colocarPecaNaFolha(GameController.getInstance().getFactoryPecas().createAnimal(new Color(255, 210, 65)));
